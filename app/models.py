...
class User(db.Model, UserMixin):
    ...
    def login(cls, username, pwd):
        '''Returns user if valid username and pass, else false'''
...
class Saved_Fiat(db.Model):
    ...
    symbol TEXT NOT NULL REFS fiat_currencies
    ```'''
    ...
    symbol = db.Column(db.Text, db.ForeignKey(
...
class Saved_Crypto(db.Model):
    ...
    id SERIAL PK,
    user_id INT NOT NULL REFS users
    symbol TEXT NOT NULL REFS crypto_currencies
    ```'''
...
class Saved_Comm(db.Model):
    ...
    id SERIAL PK,
    user_id INT NOT NULL REFS users
    symbol TEXT NOT NULL REFS commodities
    ```'''
